...
public interface ICourseService {
    /**
     * Metodo que permite crear un nuevo registro en base de datos, sobre la tabla
     * COURSE, insertando la informacion del curso que se
     * recibe mediante el DTO.
     *
     * @param courseDTO
     *                  {@link CourseDTO} Objeto con la información a insertar,
     *                  recibido en el cuerpo de la petición al servicio Rest
     * @return {@link Response} Objeto de respuesta para el servicio, el cual
     *         contiene la informacion sobre el resultado de la transaccion
     */
     ...
     * @return {@link Response} Objeto de respuesta para el servicio, el cual
     *         contiene información sobre el resultado de la consulta,
    ...
    GenericPageableResponse findAllBySubjectProgramAndSemester(final String programId, final Integer semester,
